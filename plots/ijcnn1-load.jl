function load_ijcnn1_sto(sample_rate, selected_h)
    if selected_h == "smooth"
        ...
        med_obj_sto_ijcnn1 = load_object("med_obj_sto_smooth-$(sample_rate*100)-ijcnn1-ls.jld2")
        med_metr_sto_ijcnn1 = load_object("med_metr_sto_smooth-$(sample_rate*100)-ijcnn1.jld2")
        med_mse_sto_ijcnn1 = load_object("med_mse_sto_smooth-$(sample_rate*100)-ijcnn1.jld2")
    else
...
function load_ijcnn1_plm(version, selected_h)
    if selected_h == "smooth"
        cd(raw"C:\Users\valen\Desktop\Polytechnique_Montreal\_maitrise\JLD2saves\ijcnn1\smooth_jld2")
        med_obj_prob_ijcnn1 = load_object("med_obj_prob_smooth-$(prob_versions_names[version])-ijcnn1.jld2")
        med_metr_prob_ijcnn1 = load_object("med_metr_prob_smooth-$(prob_versions_names[version])-ijcnn1.jld2")
        med_mse_prob_ijcnn1 = load_object("med_mse_prob_smooth-$(prob_versions_names[version])-ijcnn1.jld2")
    else
        cd(raw"C:\Users\valen\Desktop\Polytechnique_Montreal\_maitrise\JLD2saves\ijcnn1")
